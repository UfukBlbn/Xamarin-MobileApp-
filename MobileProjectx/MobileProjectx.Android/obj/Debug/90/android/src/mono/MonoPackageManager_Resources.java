...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "MobileProjectx.Android.dll" comes first in this list. */
		"MobileProjectx.Android.dll",
		"ExifLib.dll",
		"FormsViewGroup.dll",
		"MobileProjectx.dll",
		"SQLite-net.dll",
		...
		"Xamarin.Forms.FlexButton.Android.dll",
		"Xamarin.Forms.FlexButton.dll",
